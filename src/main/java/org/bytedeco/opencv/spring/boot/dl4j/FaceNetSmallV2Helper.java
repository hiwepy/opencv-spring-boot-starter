...
public class FaceNetSmallV2Helper {
    ...
    static String nextReluId() {
        return "relu" + FaceNetSmallV2Model.reluIndex++;
    }

    static String nextPaddingId() {
        return "padding" + (FaceNetSmallV2Model.paddingIndex++);
    }

    static String lastPaddingId() {
        return "padding" + (FaceNetSmallV2Model.paddingIndex - 1);
    }

    static String lastReluId() {
        return "relu" + (FaceNetSmallV2Model.reluIndex - 1);
    }
